...
const casesData: CaseItem[] = [
  ...
  },
  {
    ...
    description:
      'Разработали систему на Python, которая автоматически скачивает документацию тендеров с zakupki.gov.ru, анализирует её через ИИ по 12 стоп-факторам и выдаёт готовые Word-отчёты с рекомендацией — участвовать или нет. Для перспективных тендеров система автоматически подбирает поставщиков с контактами через поиск в Китае и ЕАИС.',
    details: [
      { label: 'Услуги', value: 'Python-система, DeepSeek AI, Serper API, Word/Excel-отчёты' },
      { label: 'Статус', value: 'Завершён' },
