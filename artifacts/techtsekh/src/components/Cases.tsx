...
const casesData: CaseItem[] = [
  ...
  },
  {
    ...
    description:
      'Разработали Python-скрипт, который автоматически скачивает документацию тендеров с zakupki.gov.ru, анализирует её через ИИ по 12 стоп-факторам и выдаёт готовые Word-отчёты с рекомендацией — участвовать или нет. Для перспективных тендеров скрипт автоматически подбирает поставщиков с контактами через поиск в Китае и ЕАИС.',
    details: [
